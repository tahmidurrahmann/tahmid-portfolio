    ...
    return (
        <div id="skills">
            ...
            <div className="max-w-screen-xl mx-auto px-12 lg:px-0">
                <div className="flex flex-wrap justify-center items-center gap-6 lg:gap-24">
                    <div className="flex justify-center items-center gap-12">
                        <img src="https://i.ibb.co/k0wwS3z/HTML.png" />
                        <div className="flex flex-col justify-center items-center gap-4">
                            <p className="text-xl font-bold">70%</p>
                            <progress className="progress bg-white progress-error w-52 md:w-72" value="70" max="100"></progress>
                        </div>
                    </div>
                    <div className="flex justify-center items-center gap-12">
                        ...
                        <div className="flex flex-col justify-center items-center gap-4">
                            ...
                            <progress className="progress bg-white progress-error w-52 md:w-72" value="65" max="100"></progress>
                        </div>
                    </div>
                    <div className="flex justify-center items-center gap-12">
                    <img src="https://i.ibb.co/8247qLL/Java-Script.png" />
                        <div className="flex flex-col justify-center items-center gap-4">
                            ...
                            <progress className="progress bg-white progress-error w-52 md:w-72" value="60" max="100"></progress>
                        </div>
                    </div>
                    <div className="flex justify-center items-center gap-12">
                    ...
                    <img src="https://i.ibb.co/Bs3RD3Z/tailwind.png" />
                        <div className="flex flex-col justify-center items-center gap-4">
                            ...
                            <progress className="progress bg-white progress-error w-52 md:w-72" value="90" max="100"></progress>
                        </div>
                    </div>
                    <div className="flex justify-center items-center gap-12">
                    ...
                    <img src="https://i.ibb.co/2NHC17p/express.png" />
                        <div className="flex flex-col justify-center items-center gap-4">
                            ...
                            <progress className="progress bg-white progress-error w-52 md:w-72" value="50" max="100"></progress>
                        </div>
                    </div>
                    <div className="flex justify-center items-center gap-12">
