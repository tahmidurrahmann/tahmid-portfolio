            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-screen-xl mx-auto text-white my-16 md:px-6">
                <motion.div initial={{ y: 150 }} animate={{ y: 0 }} transition={{ duration: "10", delay: "0" }}>
                    <div className="form-container mx-4 md:mx-0">
                        <form ref={form} onSubmit={sendEmail} className="bg-[#09101A] p-8 rounded-xl">
                            ...
                            <div className="flex justify-center items-center">
                                <button type="submit" className="butn"><i className="animation"></i>Send Message <FaMessage /><i className="animation"></i>
                                </button>
                            </div>
                        </form>
                    </div>
                </motion.div>
                <motion.div initial={{ y: -150 }} animate={{ y: 0 }} transition={{ duration: "10", delay: "0" }} style={{ width: "100%" }}><iframe width="100%" height="550" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=28/2%20Shamibagh,%20dhaka+(Tahmidur%20Rahman)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/population/">Population calculator map</a></iframe></motion.div>
            </div>
        </div>
    );
};
