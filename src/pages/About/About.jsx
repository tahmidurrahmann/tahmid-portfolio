...
const About = () => {
    return (
        <div id="about">
            <div className="flex flex-col lg:flex-row justify-evenly items-center gap-8 lg:gap-16 xl:gap-60 py-24 lg:py-56 max-w-screen-xl mx-auto">
                <div className="px-6">
                ...
                <div className="space-y-6 lg:w-3/4 px-16 lg:px-4">
                    <div className="flex">
                        <h1 className="text-[#c60678] text-2xl font-semibold">ABOUT ME</h1>
                    </div>
